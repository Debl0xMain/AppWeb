                ...
                $manager->persist($category1);
                    ...
                    //Sous Category
                        ...
                        $manager->persist($subcategory2);
                            ...
                            $product4->setProDesc(`37 touches miniatures sensibles à la vélocité, Polyphonie 32 voix, 42 sons (instruments), 138 types d'arpèges, Enregistreur de phrases, Effet de mouvement, Connexion USB-MIDI (configuration pour home recording DAW), Fonctionne avec 4 piles AA ou port USB (bloc d'alimentation`);
             ...
             $manager->persist($category2);
                 ...
                 //Sous Category
                     ...
                     $manager->persist($subcategory5);
                        ...
                        $product14->setProDesc(`Avec 32 kits de batterie classiques et modernes de BFD + 16 kits utilisateur, 440 sons de batterie, cymbales et percussions, Réverbération, EQ 3 bandes, 60 pistes d'accompagnement, Séquenceur, métronome et enregistreur de performance, 1 pad de caisse claire 10" deux zones de jeu avec peau maillée, 3 pads de tom 8" une zone de jeu avec peaux maillées, Pad de Crash 10" avec fonction d'étouffement, Pad de Ride 10", Pad de charleston 10" avec contrôleur au pied, Rack 4 colonnes en aluminium, Module de batterie avec des sons enregistrés de manière professionnelle à partir de la bibliothèque de batterie BFD, Streaming audio Bluetooth pour la lecture de musique sans fil, Support d'appareil intégré, Port USB/MIDI, Entrée Aux stéréo sur mini Jack 3,5 mm, Sortie ligne stéréo sur Jack 6,3 mm, Sortie casque stéréo sur mini Jack 3,5 mm, Comprend un abonnement gratuit de 90 jours à Drumeo et un abonnement gratuit de 30 jours à Melodics Premium ainsi que 60 leçons exclusives`);
            ...
            $manager->persist($category3);
                ...
                //Sous Category
                    ...
                    $manager->persist($subcategory7);
                        ...
                        $product20->setProDesc(`Taille: 1/2, Corps en tilleul, Manche en nato, Touche en érable, Diapason: 550 mm, Largeur au sillet: 45 mm, Filet de corps noir, Longueur totale: 864 mm, Cordes en nylon, Couleur: Rouge satiné, Housse adaptée optionnelle non-fournie (N° d'article 198578)`);
                    ...
                    $subcategory9->setCategorys($category3);
                        ...
                        $product26->setProDesc(`Série Custom Line Solid Wood, Forme Dreadnought avec pan coupé, Table en okoumé massif, Fond et éclisses en okoumé massif, Barrage en X sculpté (scallopé), Manche en okoumé, Touche en pau ferro, Repères "flocons de neige", Profil du manche: C ovale, Diapason: 643 mm (25,3"), Largeur au sillet: 43 mm (1,69"), Sillet de tête en os, 20 frettes, Système de micro Fishman Presys II, Chevalet en pau ferro avec sillet en os, Mécaniques ouvertes Deluxe Antique Copper, Cordes D'Addario XTAPB1253 .012-.053 (471307), Couleur: Naturel satiné`);
